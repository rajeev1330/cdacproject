    ...
    useEffect(()=>{
        ...
        if(Object.keys(errors).length===0 && submitted){
            ...
            .catch(error=>{
                ...
                alert("This Email id is already Registered. Try using another Email id")
            })            
        }
    },[errors])
    return (
        ...
        <div className="card-body">
            <div className="row">
                <div className="col-sm-200 mx-auto">
                    <h4 className="text-center p-2">
                        Customer Registration Form
                    </h4>
                    <form onSubmit={handleSubmit}>
                    <div className="form-group form-row">
                        <label className="col-sm-8 form-control-label">Customer Name</label>
                    ...
                    <div className="form-group form-row">
                        <label className="col-sm-8 form-control-label">Confirm Password</label>
                        <div className="col-sm-8">
